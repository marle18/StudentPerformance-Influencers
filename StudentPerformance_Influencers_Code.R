...
#Make columns for Upper and Lower Natural Process Limit
...
Evaluation <- function(df){
  ...
  for (i in row_index){
    ...
    EvaluationScore <- case_when(
      (LNPLbreaks == 0 and UNPLbreaks == 0) ~ "Stable",
      (
        (LNPLbreaks == 2 and UNPLbreaks == 0) |
          (LNPLbreaks == 3 and UNPLbreaks == 0) |
          (LNPLbreaks == 4 and UNPLbreaks == 0) |
          (LNPLbreaks == 5 and UNPLbreaks == 0)
      ) ~ "Declining",
      (
        (LNPLbreaks == 0 and UNPLbreaks == 2) |
          (LNPLbreaks == 0 and UNPLbreaks == 3) |
          (LNPLbreaks == 0 and UNPLbreaks == 4) |
          (LNPLbreaks == 0 and UNPLbreaks == 5)
      ) ~ "Improving",
      (
        (LNPLbreaks == 1 and UNPLbreaks == 0) |
          (LNPLbreaks == 0 and UNPLbreaks == 1)
      ) ~ "Inconclusive",
      TRUE ~ "Fluctuating"
    )
